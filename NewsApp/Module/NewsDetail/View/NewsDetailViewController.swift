...
class NewsDetailViewController: UIViewController {
    ...
    private func tableInit() {
        newsDetailCollectionView.register(NewsDetailCollectionViewCell.nib(),
                                          forCellWithReuseIdentifier: NewsDetailCollectionViewCell.cellIdentifier)
...
extension NewsDetailViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: NewsDetailCollectionViewCell.cellIdentifier,
                for: indexPath) as? NewsDetailCollectionViewCell
        else {
